...
# save png file for presentation
ggsave(filename=here("output","coastal-age-means.png"),plot=pagemfi,device="png",width=6,height=2.5)
...
# save png file for presentation
ggsave(filename=here("output","coastal-age-seroprev.png"),plot=pageprev,device="png",width=6,height=2.5)
